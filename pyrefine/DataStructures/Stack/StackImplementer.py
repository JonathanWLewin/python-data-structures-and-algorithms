...
class StackImplementer(DataStructureObject):
    ...
    def generate_examples(self):
        ...
        self._structure.push(4)
        examples.append(self.create_example_with_state('Push', 'Push to top of stack', 'self._structure.push(4)'))
        self._structure.push(5)
        self._structure.push(6)
        self._structure.push(8)
        self._structure.push(10)
        push_str = """self._structure.push(5)
self._structure.push(6)
self._structure.push(8)
self._structure.push(10)"""
        examples.append(self.create_example_with_state('Push', 'Push to top of stack', push_str))
